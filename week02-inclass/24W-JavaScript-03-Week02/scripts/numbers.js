  /* STEP 1: Number types (integer, float, and double)
   ...
   console.log("modulo:" + mod); 
    ...
    var num5 = 20;
    console.log(num5++); //display the number first and increment later
    console.log(num5); //then num5 = 21
    console.log(++num5);  //num5 will plus first then show up directly
    ...
    var num6 = 5;
    var final = 20;
    final += num6; //final = final + num6 // 25 = 20 + 5
    console.log(final);

    final -= num6; //final = final - num6 // 20 = 25 - 5
    console.log(final); 

    final *= num6; //final = final * num6 // 100 = 20 * 5
    console.log(final); 

    final /= num6; //final = final / num6 // 20 = 100 / 5
    console.log(final); 
    ...
    console.log(num7a == num7b); //just check the output content
    console.log(num7a === num7b); //this one will check the data type
    console.log(num7a == num7c);
    console.log(num7a === num7c);
    console.log(num7a !== num7c);  //!== !=
    console.log(num7a != num7c); 

    console.log(num7a > 3); //true
    console.log(num7a < 3); //false
    console.log(num7a <= 3); //true
