...
/* STEP 2: Retrieving a Specific String Character starting with '0' */
...
output.textContent = myString.slice(4, 8); //o! H
output.textContent = myString.slice(4); //o! How are you are?
...
output.textContent = myString.replace("are", "is"); //Hello! How is you are?
output.textContent = myString.replaceAll("are", "is"); //Hello! How is you is?
